export class ImageButton {
    ...
    handleClick(mouseX: number, mouseY: number, devicePixelRatio: number) {
        ...
        console.log("this.x", this.x* devicePixelRatio, " ddd ", (this.x + this.width) * devicePixelRatio);
        console.log("this.y", this.y* devicePixelRatio, " ddd ", (this.y + this.height) * devicePixelRatio);
      if (
        mouseX >= this.x * devicePixelRatio &&
        mouseX <= (this.x + this.width) * devicePixelRatio &&
        mouseY >= this.y * devicePixelRatio &&
