export class Joystick {
    ...
    render(context: CanvasRenderingContext2D, devicePixelRatio: number) {
      ...
      context.beginPath();
      context.arc(this.baseX/devicePixelRatio, this.baseY/devicePixelRatio, this.baseRadius, 0, Math.PI * 2);
      context.fillStyle = "rgba(0, 0, 0, 0.3)";
      context.fill();
  
      // Draw the joystick handle
      context.beginPath();
      context.arc(this.handleX/devicePixelRatio, this.handleY/devicePixelRatio, this.handleRadius, 0, Math.PI * 2);
